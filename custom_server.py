...
class CustomServerWithOauth2:
	...
	def __init__(self, logger: logging.Logger, serverapp: Server, settings: Settings):
		self.logger = logger
		...
		if not self.settings.no_auth:
		 self.oauth = OAuth2Manager(logger, issuer=settings.base_url)
